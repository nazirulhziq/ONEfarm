        ...
        <section class="popular">
            <div class="container">
                ...
                <div class="row">
						...
						$query_res= mysqli_query($db,"select * from animal where animalAvail='0' LIMIT 3"); 
						                       ...
						                       echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
														<div class="food-item-wrap">
															...
															<div class="content">
																...
																<div class="price-btn-block"> <span class="price">RM'.$r['animalPrice'].'</span> <a href="animal.php?res_id='.$r['breedID'].'" class="btn theme-btn-dash pull-right">Order Now</a> </div>
															</div>
